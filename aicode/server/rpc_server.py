...
from aicode.llm.exceptions import APIError, ConfigError, ModelNotFoundError
...
class RPCServer:
    ...
    def initialize(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 加载默认模型
            model_name = params.get("model") or self.config_manager.get(
    ...
    def chat(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Chat response generated, tokens: {token_count}, edits: {len(edits)}"
            )
    ...
    def apply_edit(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "file_path": file_path, "edit_type": edit_type}
